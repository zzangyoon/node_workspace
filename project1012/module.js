...
모듈이란? 우리가 지금까지 정의해온 자바스크립트 라이브러리를 파일로 저장해놓은 단위
...
//내장모듈 - os 모듈
//자바스크립트와는 달리, 모듈을 가져올때는 require() 함수를 이용해야 한다(js에서는 src로 가져왔었음)
/*
...
//이렇게 특정 이벤트가 발생할때 시스템에 의해 역으로 호출되는 유형의 함수를 callback 함수라 한다
